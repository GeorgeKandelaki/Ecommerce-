...
exports.cart = void 0;
exports.createCartProductObj = createCartProductObj;
exports.deleteProductFromCart = deleteProductFromCart;
exports.getAllProductsForUser = getAllProductsForUser;
...
function getAllProductsForUser() {
  return _getAllProductsForUser.apply(this, arguments);
}
function _getAllProductsForUser() {
  _getAllProductsForUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var res;
...
(function () {
  var _getCart = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var prods;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return getAllProductsForUser();
        case 2:
          prods = _context.sent;
          if (!prods) {
            _context.next = 7;
          ...
          cart.products = _construct(Array, _toConsumableArray(prods.data.products));
...
function updateQuantityOfProduct(product, mode, el) {
  if (mode === 'increment') {
    product.quantity++;
...
function createCartProductObj(data) {
  return {
    user: data.user,
...
function addProductToCart(_x) {
  return _addProductToCart.apply(this, arguments);
}
function _addProductToCart() {
  _addProductToCart = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://95.104.13.159:8080/api/v1/cart/".concat(id),
            data: {
              id: id
            }
          });
...
function deleteProductFromCart(_x2) {
  return _deleteProductFromCart.apply(this, arguments);
}
function _deleteProductFromCart() {
  _deleteProductFromCart = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js"}],"utils.js":[function(require,module,exports) {
"use strict";
...
function _arrayWithoutHoles(r) { if (Array.isArray(r)) return _arrayLikeToArray(r); }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function joinTemplate(arr, templateFn) {
  var join = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var newArr = arr.map(function (el) {
    return templateFn(el);
  });
  if (join) return newArr.join('');
  return newArr;
}
function renderHTML(parentEl, HTML, position) {
...
function findUsingId(arr, condition) {
  var found;
...
function deleteById(arr, condition) {
...
if (loginForm) {
  loginForm.addEventListener('click', function (e) {
    ...
    if (target.matches('.btn-submit')) {
      var email = document.querySelector('.form__email-input').value;
      var password = document.querySelector('.form__password-input').value;
...
if (signupForm) {
  signupForm.addEventListener('click', function (e) {
    ...
    var target = e.target;
    if (target.matches('.btn-submit')) {
      var name = document.querySelector('.form__name-input').value;
      var email = document.querySelector('.form__email-input').value;
      var password = document.querySelector('.form__password-input').value;
      var passwordConfirm = document.querySelector('.form__confirm-password-input').value;
...
document.body.addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var target, _target$closest, id, cartProd, _target$closest2, _id, _target$closest3, _id2, product, productQnt, _target$closest4, _id3, _product, _productQnt;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          target = e.target;
          ...
          return _context.abrupt("return", cartContainer.classList.toggle('cart--active'));
        case 3:
          if (!target.matches('.btn-purchase')) {
            _context.next = 11;
            break;
          }
          _target$closest = target.closest('.product'), id = _target$closest.id;
          _context.next = 7;
          return (0, _cart.addProductToCart)(id);
        case 7:
          cartProd = _context.sent;
          _cart.cart.quantity++;
          _cart.cart.products.push((0, _cart.createCartProductObj)(cartProd.data.data));
          return _context.abrupt("return", true);
        case 11:
          ...
          _target$closest2 = target.closest('.cart-product'), _id = _target$closest2.id;
          if (_cart.cart.quantity > 0) _cart.cart.quantity--;
          _cart.cart.products = (0, _utils.deleteById)(_cart.cart.products, function (obj) {
            return _id == obj.id;
          });
          return _context.abrupt("return", (0, _cart.deleteProductFromCart)(_id));
        case 16:
          if (!target.matches('.btn--decrement-qnt')) {
            _context.next = 21;
            break;
          }
          _target$closest3 = target.closest('.product'), _id2 = _target$closest3.id;
          product = (0, _utils.findUsingId)(_cart.cart.products, function (obj) {
            return _id2 == obj.product;
          });
          productQnt = document.querySelector('.product__qnt');
          return _context.abrupt("return", (0, _cart.updateQuantityOfProduct)(product, 'decrement', productQnt));
        case 21:
          if (!target.matches('.btn--increment-qnt')) {
            _context.next = 26;
            break;
          }
          _target$closest4 = target.closest('.product'), _id3 = _target$closest4.id;
          _product = (0, _utils.findUsingId)(_cart.cart.products, function (obj) {
            return _id3 == obj.product;
          });
          _productQnt = document.querySelector('.product__qnt');
          return _context.abrupt("return", (0, _cart.updateQuantityOfProduct)(_product, 'increment', _productQnt));
        case 26:
        case "end":
          return _context.stop();
      }
...
},{"./login":"login.js","./signup":"signup.js","./cart":"cart.js","./utils":"utils.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
